...
class In_Frame //implements Runnable
{
	...
	String egg="";
	static String text1;
	static Vector<String> msg=new Vector<>();
	static Vector<String> len=new Vector<>();	
	static Vector<String> des=new Vector<>();	
	static Vector<String> sour=new Vector<>();
